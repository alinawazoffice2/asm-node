...
exports.Commander = function () {
    ...
    this.MAP = function(v1, v2){
        me.TMP_METHOD.code.push({command: 'map', to: v1, from: v2});
    }
    ...
    this.CMP = function(v1, v2, v3){
        me.TMP_METHOD.code.push({command: 'cmp', v1: v1, v2: v2, label: v3});
    }

    this.STF = function(v1){
        me.TMP_METHOD.code.push({command: 'stf', filename: v1});
    }

    this.STFP = function(v1){
        me.TMP_METHOD.code.push({command: 'stfp', filename: v1});
    }
    ...
    this.PTS = function(v1){
        me.TMP_METHOD.code.push({command: 'pts', from: v1});
    }

    this.PFS = function(v1){
        me.TMP_METHOD.code.push({command: 'pfs', to: v1});
    }
