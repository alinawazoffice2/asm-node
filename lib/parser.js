        ...
        LNK.include(me.tokens, function(tokens){
            ...
            {            
                ...
                if(token == 'def'){
                    ...
                    continue;
                }else if(token == 'stf'){ // stack to file
                    me.expectTokens(1);
                    me.pointer+=1;
                    CMD.STF(me.tokens[me.pointer]);
                    continue;
                }else if(token == 'stfp'){ // stack to file preserve (append)
                    me.expectTokens(1);
                    me.pointer+=1;
                    CMD.STFP(me.tokens[me.pointer]);
                    continue;
                }else if(token == 'out'){
                    me.expectTokens(1);
                    me.hasNextRegister();
                    ...
                    continue;
                }else if(token == 'pts'){ //push to stack
                    me.expectTokens(1);
                    me.hasNextRegister();
                    me.pointer+=1;
                    CMD.PTS(me.tokens[me.pointer]);
                    continue;
                }else if(token == 'pfs'){ // pop from stack
                    me.expectTokens(1);
                    me.hasNextRegister();
                    me.pointer+=1;
                    CMD.PFS(me.tokens[me.pointer]);
                    continue;
                }else if(token == 'lbl'){
                    me.expectTokens(1);
                    me.pointer+=1;
